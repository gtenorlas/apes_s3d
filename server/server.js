...
const accumulativeMatchesRoutes = require('./routes/accumulativeMatches-api');
const announcementsRoutes = require('./routes/announcements-api');
...
app.use('/api/accumulativematches',accumulativeMatchesRoutes);
